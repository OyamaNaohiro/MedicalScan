...
RCT_EXPORT_VIEW_PROPERTY(sensor, NSInteger)
...
RCT_EXPORT_VIEW_PROPERTY(cameraFollow, BOOL)
...
RCT_EXPORT_VIEW_PROPERTY(globalOptimize, BOOL)
RCT_EXPORT_VIEW_PROPERTY(worldTracking, BOOL)
RCT_EXPORT_VIEW_PROPERTY(depthOdometry, BOOL)
RCT_EXPORT_VIEW_PROPERTY(mirrorMode, BOOL)
RCT_EXPORT_VIEW_PROPERTY(mirrorRoll, NSInteger)
RCT_EXPORT_VIEW_PROPERTY(mirrorPitch, NSInteger)
RCT_EXPORT_VIEW_PROPERTY(colorBaking, BOOL)
